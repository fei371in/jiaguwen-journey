           ...
           <section className="bg-white rounded-2xl shadow-sm flex flex-col p-4">
               ...
               <div className="w-full aspect-square relative bg-white border-2 border-[#E5E5EA] rounded-lg overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-80 mix-blend-multiply">
                        <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCd_DBGTmLIYTNEjlyYItIwOV9B7D4cenP51y_9XwRnQq4zZ2RhlsGn1OBwiVVzyfJB-S6uxznIZoGSWUdwTNl4PKRouQDtbuCO7W4v7gXOaCd5UFVcgdilHVCG8-PcxpQb_nsLUrLglgXxjda1wgxrjLk0uzroSHw7cL9MZJNs4gjRr86wIEK7rOuwW_uWFjgiJEf5S9RRBgDuUTWyh0hnHditeT1-H9m0R7681K5zPY0qVontSCT5u50RlFf9Fs11zuN8UfGfZYu4" alt="Trace" className="w-3/4 h-3/4 object-contain" />
                    </div>
               </div>
           </section>
       </main>
